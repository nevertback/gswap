...
function(t) {
	...
	$.f
	n.ContentCorrect = function(options) {
		return this.each(function() {
			var $this = $(this);
			$this.click(function(event) {
				event.preventDefault(), loadJs("uploadify", "http://j.gamersky.com/Uploadify/jquery.uploadify.js", function() {
...
!
function(t) {
	var a = "http://db5.gamersky.com/LabelJsonpAjax.aspx";
		...
		return a && t.extend(e, a), this.each(function() {
			t(e.videoSource).on("touchend", function(a) {
				...
				case "56":
					...
					break;
				case "iqiyi":
					c = r.replace("&coop=测试&cid=", "") + "&cid=qc_105082_300395&bd=1&autoplay=1&coop=coop_1010_ymxk&source=" + s, d = !0, l = c;
					break;
				case "17173":
			...
			success: function(t) {
				...
				function e() {
					...
					$(".ymwJJtabcon li[data-hit='1']").each(function(e, n) {
						parseInt($(n).attr("data-playorder")) >= t && parseInt($(n).attr("data-playorder")) <= a ? $(n).sh
						ow() : $(n).hide()
	...
	ymwsyScoreFun: function() {
		...
		function n() {
			...
			$.ajax({
				...
				dataType: "jsonp",
				url: "http:/
/i.gamersky.com/apirating/initgroup",
				data: {
					generalId: t,
					ratingGroupType: a,
					Action: "initGroup"
	...
	ymwListZoneFunc: function() {
		...
		function createListCon(itemData, key) {
			...
			return listConDom += '</ul><a class="lmz_more
 ymwListZoneMore" data-list="' + key + '">点击展开</a>', listConDom += "</div>", 0 == itemsShow && (listConDom = "", newArrayData = []), [listConDom, newArrayData]
		}
		...
		ymwKulistloadmoreFun: function() {
			function t(a) {
				...
				$.ajax({
					...
					error: function() {
						navigator.userAgent.indexOf("UCBrowser") > -1 && alert("请关闭UC浏览器 设置-广告过滤
 以获得正常的访问效果")
					}
				})
			}
...
//# sourceMappingURL=gamersky.mobile.v4.min.js.map